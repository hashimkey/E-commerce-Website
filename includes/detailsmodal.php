...
$sql_1 = "SELECT brand FROM brand WHERE id = '$brand_id'";
$brand_query = $db->query($sql_1);
        ...
        <div class="h">
          ...
          <div class="col-sm-6 fotorama">
            ...
            <div class="center-block">
              <img src="<?php echo $photo;?>" alt="<?php echo $product['title']; ?>" style="width:50%; margin: 15px;" class="details img-responsive" />
            </div>
              <?php endforeach ; ?>
          </div>
          <div class="col-sm-6">
            ...
            <p>Brand: <?php echo $brand_result['brand']; ?></p>
