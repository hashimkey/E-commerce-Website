    ...
    <div class="form-group col-md-3">
      ...
      <select class="form-control" id="brand" name="brand">
        ...
        <?php while($brandB = mysqli_fetch_assoc($brandQuery)): ?>
          <option value="<?=$brandB['id'];?>"<?=(($brand == $brandB['id'])?' selected':'');?>><?=$brandB['brand'];?></option>
        <?php endwhile; ?>
      </select>
    </div>
    <div class="form-group col-md-3">
        ...
        $images = explode(',',$saved_image); ?>
          <?php foreach($images as $image):?>
            <div class="saved-image col-md-4">
              <img src="<?=$image;?>" alt="saved_image"/ class="details img-responsive"><br>
  ...
  <tbody>
    <?php while($product = mysqli_fetch_assoc($presults)):
      ...
      <tr>
        ...
        </a>&nbsp <?=(($product['featured'] == 1)?'Featured Product':'Add feature');?></td>
        <td>0</td>
      </tr>
    <?php endwhile; ?>
  </tbody>
